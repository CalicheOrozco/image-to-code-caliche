...
export default function Home() {
	...
	const copyToClipboard = async (htmlContent: string) => {
		try {
	...
	return (
		<div className="grid grid-cols-1 md:grid-cols-[400px_1fr]">
			<aside className="flex flex-col justify-between md:min-h-screen p-4 bg-gray-900 text-white">
				...
				<footer className="text-sm bg-gray-900 text-white p-4">
				...
				<section className="max-w-2xl mx-auto p-10">
					...
					{step === STEPS.PREVIEW && (
						<div className="rounded flex flex-col gap-4">
							<div
								className="w-full h-full rounded border-4 border-gray-400 aspect-video"
					...
					{step === STEPS.ERROR && (
						<div className="text-red-500">
							<p>Error occurred while generating code. Please try again.</p>
						</div>
					)}
				</section>
			</main>
